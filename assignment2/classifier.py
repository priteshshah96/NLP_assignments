import time, random, argparse, sys, re, os
import numpy as np
...
class BertSentClassifier(torch.nn.Module):
    def __init__(self, config):
        ...
        # Load the pre-trained BERT model (the model name should be "bert-base-uncased")
        # todo (hint: self.bert = ...)
...
class BertDataset(Dataset):
    def __init__(self, dataset, args):
        ...
        # Load the tokenizer of the pre-trained BERT model (the model name should be "bert-base-uncased")
        # todo (hint: self.tokenizer = ...)
        raise NotImplementedError
...
def create_data(filename, flag='train'):
    # specify the tokenizer (hint: tokenizer = ...)
    # todo
    raise NotImplementedError
